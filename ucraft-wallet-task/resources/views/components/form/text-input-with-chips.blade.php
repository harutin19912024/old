...
<div
    ...
    class="input-with-chips relative mb-5 flex flex-col"
>
    <label
    ...
    <x-icon
        ...
        @click="open = true; $refs.chipsInput.focus()"
    />
    ...
    <div class="flex flex-wrap pt-3">
        ...
        >
            <div
                class="bg-default-text mr-2 mb-2 flex h-7 min-w-[70px] items-center justify-between rounded-2xl px-2 py-1 hover:bg-[#333333]">
                <p
                    x-text="item.value"
                    class="font-primary text-secondary-white text-subtitle-2 mr-2 font-medium"
                ></p>

                <button @click.prevent="state.splice(state.indexOf(item.key), 1)">
                    <x-icon
                        name="cross"
