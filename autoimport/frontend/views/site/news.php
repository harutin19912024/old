<section class="breadcumb-area bg-img" style="background-image: url(/img/bg-img/cover_img6.jpg);">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcumb-content">
                        <h3 class="breadcumb-title">Նորություններ</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="south-blog-area section-padding-100">
        <div class="container">
                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="single-blog-area mb-50">
                        ...
                        <div class="blog-post-thumbnail">
                            <img src="/img/bg-img/cover_img7.jpg" alt="">
                        </div>
                        <!-- Post Content -->
                        <div class="post-content">
                            <!-- Date -->
                            <div class="post-date">
                                <a href="#">Դեկտեմբեր 09, 2018թ.</a>
                            </div>
                            <!-- Headline -->
                            <a href="#" class="headline">3 Տարում կկառուցվի 1000 Բնակարան</a>
                            <!-- Post Meta -->
                            <div class="post-meta">
                                <p>By <a href="#">Admin</a> | in <a href="#">Uncategorized</a> | <a href="#">2 Comments</a></p>
                            </div>
                            <p>Կառավարությունն այսօր բնակարանային պայմանների բարելավման կարիք ունեցող երիտասարդ ընտանիքներին պետական նպատակային ծրագրի հասանելիության բարձրացման անհրաժեշտությամբ պայմանավորված որոշում ընդունեց:</p>
                            <!-- Read More btn -->
                            <a href="#" class="btn south-btn btn-overlay"> <span>Տեսնել ավելին</span></a>
                        </div>
                    </div>
                    ...
                    <div class="single-blog-area mb-50">
                        ...
                        <div class="post-content">
                            ...
                            <!-- Read More btn -->
                            <a href="#" class="btn south-btn btn-overlay"><span>Read More</span></a>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-12">
                    <!-- Pagination -->
                    <div class="south-pagination d-flex">
