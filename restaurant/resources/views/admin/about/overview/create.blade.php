                    ...
                    <div class="panel-body">
                        <form method="post" action="{{ $route }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="title">Имя<strong class="text-danger"> &#42; </strong> </label>
                                @error('title')
                            ...
                            <div class="form-group">
                                <label for="description">Текст <strong class="text-danger">
                                        &#42; </strong></label>
                                @error('text1')
                                <p class="invalid-feedback text-danger" role="alert"><strong>{{ $message }}</strong></p>
                                @enderror
                            ...
                            <div class="form-group">
                                <label for="logo">Загрузить фото<strong class="text-danger"> &#42; </strong></label>
                                @error('path')
                                <p class="invalid-feedback text-danger" role="alert"><strong>{{ $message }}</strong></p>
                                @enderror
