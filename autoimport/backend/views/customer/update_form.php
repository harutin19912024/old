        ...
        <div class="panel-body p20 pb10">
            <div class="tab-content pn br-n admin-form">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group field-customeraddress-country">
                                                ...
                                                {input}</label>{error}</div>'
                                                    ...
                                                    'data' => $countryArray,
                                                    'language' => Yii::$app->language,
                                                    'options' => ['placeholder' => Yii::t('app', 'Select a Country') . '...', 'name'=>'CustomerAddress[address][country]'],
                                                    'pluginOptions' => [
                                                        'allowClear' => true
                                                    ],
                                                ])->label(false);
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group field-customeraddress-country">
                                                ...
                                                {input}</label>{error}</div>'
                                                    ...
                                                    'data' => $statesArray,
                                                    'language' => Yii::$app->language,
                                                    'options' => ['placeholder' => Yii::t('app', 'Select a Country') . '...', 'name'=>'CustomerAddress[address][state]'],
                                                    'pluginOptions' => [
                                                        'allowClear' => true
                                                    ],
                                                ])->label(false);
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group field-customeraddress-country">
                                                <input type="text" id="customeraddress-sity<?=$key?>" class="form-control"
                                                       name="CustomerAddress[address][city]" placeholder="City" value="<?= $customerAddress_model->city ?>">
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="form-group field-customeraddress-country">
                                                <input type="text" id="customeraddress-address<?=$key?>" class="form-control"
                                                       name="CustomerAddress[address][address]" placeholder="Address" value="<?= $customerAddress_model->address ?>">
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="form-group col-md-12">
                    ...
                    <?php echo Html::a(Yii::t('app', 'Reset'), Url::to('/' . Yii::$app->language . '/customer/index', true), ['class' => 'btn btn-default btn-sm ph25 reste-button pull-right']); ?>
                </div>
            </div>
        </div>
