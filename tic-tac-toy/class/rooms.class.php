...
class Rooms extends Crud
{
    ...
    public function cleanRoom($id, $reset = true)
    {
        try {
            if($reset) {
        ...
        div5 = '', div6 = '', div7 = '', div8 = '' WHERE id = ?");
                ...
                $query = Connection::getCon()->prepare("INSERT INTO $this->historyTable (player1, player2, played, div0, div1, div2, div3, div4, 
        div5, div6, div7, div8, wins, defeats) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
            }
