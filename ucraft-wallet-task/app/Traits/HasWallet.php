...
trait HasWallet
{
    ...
    {
        /** @var Wallet $this */
        return app(RegulatorService::class)->amount(app(CastService::class)->getWallet($this));
    }
     ...
     * @throws ExceptionInterface
     */
    public function transfer(Wallet $wallet, int|string $amount): Transfer
    {
        return app(AtomicServiceInterface::class)->block($this, function () use ($wallet, $amount): Transfer {
            /** @var Wallet $this */
            app(ConsistencyServiceInterface::class)->checkPotential($this, $amount);

            return $this->forceTransfer($wallet, $amount);
        });
    }
